    ...
    <style>
        ...
        * {
        ...
        .login_topimg {
            ...
            min-height: 185px;
            position: relative;
            background: #FFF url(<?= HTTP_PAGE . "img/stat.gif" ?>) no-repeat;
...
<body>
    <div class="limiter" id="login">
        <div class="container-login100" style="background-image:url(<?= HTTP_PAGE . "img/stock.jpeg" ?>)">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <fieldset>
                                ...
                                <form class="login100-form validate-form" method="POST" action="<?php echo HTTP_EXEC ?>login.php">
                                    ...
                                    <div class="wrap-input100 validate-input m-b-16" data-validate="Valid email is required: ex@abc.xyz">
                                        <input class="input100" type="text" id="user_login" name="user_login" placeholder="<?= _getText("login") ?>"> <span class="focus-input100"></span> <span class="symbol-input100"> <span class="glyphicon glyphicon-user"></span> </span>
                                    </div>
                                    <div class="wrap-input100 validate-input m-b-16" data-validate="Password is required">
                                        <input class="input100" type="password" name="user_pwd" placeholder="<?= _getText("mot.de.passe") ?>"> <span class="focus-input100"></span> <span class="symbol-input100"> <span class="glyphicon glyphicon-lock"></span> </span>
                                    </div>
